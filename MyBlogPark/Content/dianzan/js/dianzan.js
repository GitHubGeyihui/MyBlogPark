	...
	function init() {
		...
		new Animocon(el3, {
			tweens: [new mojs.Burst({
				...
				delay: 300,
				shape: 'circle',
				fill: ['#EF7A7A', '#EF7A7A', '#8AAEDE', '#8ADEAD', '#DEC58A', '#8AD1DE'],
				x: '50%',
				y: '50%',
				opacity: 0.6,
				radius: {
		...
		new Animocon(el15, {
			tweens: [new mojs.Burst({
				...
				onUpdate: function(progress) {
					...
					el15.style.color = colorProgress ? '#9BBADC' : '#EF7A7A';
				}
			})],
			onUnCheck: function() {
				el15.style.color = '#EF7A7A';
			}
		});
		...
		new Animocon(el16, {
			tweens: [new mojs.Burst({
				...
				onUpdate: function(progress) {
					...
					el16.style.color = progress >= 0.75 ? '#FF6767' : '#EF7A7A';
				}
			})],
			onUnCheck: function() {
				el16.style.color = '#EF7A7A';
			}
		});
